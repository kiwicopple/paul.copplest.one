...
flowchart LR
    ...
    B -->|2| C["Mental state<br/><small>Citta</small>"]
    C -->|3| D["Mental objects<br/><small>Dhammā</small>"]
    D -->|4| B
    B -->|5| A
```
...
```mermaid
flowchart TD
    A["Contact arises"] --> B["Perception intercepts"]
    B -->|Bypass| C["Label applied<br/><small>'This is ego' · 'Let go'</small>"]
    B -->|Wisdom| D["Before labelling<br/><small>raw texture of experience</small>"]
    C --> E["No genuine contact"]
    D --> F["Genuine contact"]
```
